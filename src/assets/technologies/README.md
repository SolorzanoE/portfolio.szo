...
- `ai/claude.webp`: Optimized Claude icon from the official Claude website apple-touch-icon.
- `ai/chatgpt.svg` and `ai/chatgpt-dark.svg`: OpenAI monoblossom assets from
  https://cdn.openai.com/brand/OpenAI-Logos-2025.zip.
- `ai/gemini.webp`: Optimized Gemini Spark icon from the official Google Press Corner.
